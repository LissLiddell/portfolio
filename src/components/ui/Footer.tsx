        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-3">
              <a 
                ...
                className="w-8 h-8 bg-[#1F1A2E] border border-[#7C3AED]/20 rounded-lg flex items-center justify-center text-gray-400 hover:text-[#A78BFA] hover:border-[#A78BFA] transition-all duration-300"
                aria-label="GitHub"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#skills" className="text-gray-400 hover:text-[#A78BFA] transition-colors text-sm">
                  Skills
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><span className="text-gray-400 text-sm">Three.js</span></li>
              <li><span className="text-gray-400 text-sm">AWS</span></li>
            </ul>
          </div>
        </div>
